...
class CatOtroScreen extends StatefulWidget {
  const CatOtroScreen({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _CatOtroScreenState createState() => _CatOtroScreenState();
}

class _CatOtroScreenState extends State<CatOtroScreen> {
