...
class CatArbolScreen extends StatefulWidget {
  const CatArbolScreen({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _CatArbolScreenState createState() => _CatArbolScreenState();
}

class _CatArbolScreenState extends State<CatArbolScreen> {
  // ignore: prefer_final_fields
  String _text = 'Arboleda';

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Arboles'),
      ),
      body: Column(
        children: [
          Expanded(
